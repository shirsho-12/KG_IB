...
if args.dataset == "webnlg":
    dataset_path = Path("output/output/webnlg/s_1_extracted.pkl")
elif args.dataset == "rebel":
    dataset_path = Path("output/output/rebel/s_1_extracted.pkl")
elif args.dataset == "wiki-nre":
    dataset_path = Path("output/output/wiki-nre/s_1_extracted.pkl")
else:
